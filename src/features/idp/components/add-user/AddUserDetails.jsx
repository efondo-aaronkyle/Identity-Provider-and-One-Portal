  ...
  return (
    <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); onNext(); }}>
      ...
      <div>
        ...
        <label className="input rounded-lg flex items-center gap-2 bg-transparent border border-gray-300 text-gray-700 w-full focus-within:ring-1 focus-within:ring-blue-200 focus-within:border-blue-200">
      ...
      <div>
        ...
        <label className="input flex items-center gap-2 rounded-lg bg-transparent border border-gray-300 text-gray-700 w-full focus-within:ring-1 focus-within:ring-blue-200 focus-within:border-blue-200">
          <span className="pr-3 border-r border-gray-300 text-gray-500">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
      ...
      <div>
        ...
        <input
          ...
          className="input bg-transparent border rounded-lg border-gray-300 text-gray-700 w-full focus-within:ring-1 focus-within:ring-blue-200 focus-within:border-blue-200"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="input bg-transparent border rounded-lg border-gray-300 text-gray-700 w-full focus-within:ring-1 focus-within:ring-blue-300 focus-within:border-blue-300"
        />
      </div>

      <div className="flex justify-end gap-2 pt-4">
        <button type="button" onClick={() => navigate(-1)} className="btn btn-outline text-[#991b1b] border-[#991b1b] hover:bg-[#ffd700] hover:border-[#ffd700] hover:text-[#991b1b]">
            Cancel
        </button>
